  ...
  const projects: Project[] = [
    {
      ...
      highlights: [
        "Backend (Python/Flask): Real-time vehicle detection, parking slot management, dynamic pricing with fuzzy logic, REST API, and video streaming.",
        "Frontend (React/TypeScript): Live dashboard with occupancy trends, dynamic pricing updates, and video feed using API/WebSocket, styled with Tailwind CSS.",
        "Architecture: Client-server model with intelligent backend processing and responsive real-time frontend."
      ],
